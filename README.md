...
alembic upgrade head
```
- Для проверки корректности работы миграций можно зайти в БД с помощью DBeaver или другого инструмента для работы с СУБД. Логин и пароль можно взять в settings.py. В окне соединения: Хост - localhost, Порт - 5433, База данных - run_tracker.
